...
/* SIP message structure */
   ...
   extern int _sip_copy_header (_sip_msg_t *, _sip_header_t *, char *, boolean_t);
   extern int _sip_find_and_copy_header (_sip_msg_t *, _sip_msg_t *, char *, char *);
   extern int _sip_find_and_copy_all_header (_sip_msg_t *, _sip_msg_t *, char *header_name);
   extern _sip_header_t *sip_search_for_header (_sip_msg_t *, char *, _sip_header_t *);
   extern void _sip_add_header (_sip_msg_t *, _sip_header_t *, boolean_t, boolean_t, char *);
   ...
   extern int sip_parse_allow_events_header (_sip_header_t *, sip_parsed_header_t **);
   extern int sip_parse_event_header (_sip_header_t *, sip_parsed_header_t **);
   ...
   extern int sip_parse_alert_header (_sip_header_t *, sip_parsed_header_t **);
   ...
   extern int sip_parse_ppreferredid_header (_sip_header_t *, sip_parsed_header_t **);
   extern int sip_parse_priority_header (_sip_header_t *, sip_parsed_header_t **);
   extern int sip_parse_org_header (_sip_header_t *, sip_parsed_header_t **);
   ...
   extern int sip_parse_privacy_header (_sip_header_t *, sip_parsed_header_t **);
   extern int sip_parse_expire_header (_sip_header_t *, sip_parsed_header_t **);
   extern int sip_parse_errorinfo_header (_sip_header_t *, sip_parsed_header_t **);
   ...
   extern int sip_parse_callinfo_header (_sip_header_t *, sip_parsed_header_t **);
   ...
   extern int sip_parse_cseq_header (_sip_header_t *, sip_parsed_header_t **);
   extern int sip_parse_cid_header (_sip_header_t *, sip_parsed_header_t **);
   extern int sip_parse_first_line (_sip_header_t *, sip_message_type_t **);
   ...
   extern int sip_parse_maxf_header (_sip_header_t *, sip_parsed_header_t **);
   extern int sip_parse_ctype_header (_sip_header_t *, sip_parsed_header_t **);
   extern int sip_parse_unknown_header (_sip_header_t *, sip_parsed_header_t **);
   ...
   extern int sip_parse_pauthor_header (_sip_header_t *, sip_parsed_header_t **);
   extern int sip_parse_pauthen_header (_sip_header_t *, sip_parsed_header_t **);
   extern int sip_parse_wauthen_header (_sip_header_t *, sip_parsed_header_t **);
   ...
   extern int sip_parse_ppreferredid (_sip_header_t *, sip_parsed_header_t **);
   extern int sip_parse_privacy_header (_sip_header_t *, sip_parsed_header_t **);

   extern boolean_t sip_ok_to_modify_message (_sip_msg_t *);
