...
/* Transaction states */
#define	SIPS_NEW_TRANSACTION		0

/* Client Transaction States */
#define	SIPS_CLNT_CALLING		1
#define	SIPS_CLNT_INV_PROCEEDING 	2
#define	SIPS_CLNT_INV_TERMINATED 	3
#define	SIPS_CLNT_INV_COMPLETED		4
#define	SIPS_CLNT_TRYING		5
#define	SIPS_CLNT_NONINV_PROCEEDING 	6
#define	SIPS_CLNT_NONINV_TERMINATED 	7
#define	SIPS_CLNT_NONINV_COMPLETED	8

/* Server Transaction States */
#define	SIPS_SRV_INV_PROCEEDING		9
#define	SIPS_SRV_INV_COMPLETED		10
#define	SIPS_SRV_CONFIRMED		11
#define	SIPS_SRV_INV_TERMINATED		12
#define	SIPS_SRV_TRYING			13
#define	SIPS_SRV_NONINV_PROCEEDING	14
#define	SIPS_SRV_NONINV_COMPLETED	15
#define	SIPS_SRV_NONINV_TERMINATED	16
...
/* SIP header function table */
   typedef struct header_function_table
   {
      ...
      int (*header_parse_func) (struct sip_header *, struct sip_parsed_header **);
         boolean_t (*header_check_compliance) (struct sip_parsed_header *);
         boolean_t (*header_is_equal) (struct sip_parsed_header *, struct sip_parsed_header *);
...
/* Connection Manager interface */
   typedef struct sip_io_pointers_s
   {
      ...
      int (*sip_conn_remote_address) (sip_conn_object_t, struct sockaddr *, socklen_t *);
      int (*sip_conn_local_address) (sip_conn_object_t, struct sockaddr *, socklen_t *);
...
/* Upper layer registerations */
   ...
   {
      void (*sip_ulp_recv) (const sip_conn_object_t, sip_msg_t, const sip_dialog_t);
         uint_t (*sip_ulp_timeout) (void *, void (*func) (void *), struct timeval *);
...
extern int sip_setup_header_pointers (sip_msg_t);
extern boolean_t sip_check_common_headers (sip_conn_object_t, sip_msg_t);
   ...
   extern int (*sip_conn_rem_addr) (sip_conn_object_t, struct sockaddr *, socklen_t *);
   extern int (*sip_conn_local_addr) (sip_conn_object_t, struct sockaddr *, socklen_t *);
   ...
   extern uint_t (*sip_stack_timeout) (void *, void (*func) (void *), struct timeval *);
   ...
   extern int sip_sendmsg (sip_conn_object_t, sip_msg_t, sip_dialog_t, uint32_t);
   extern void sip_process_new_packet (sip_conn_object_t, void *, size_t);
   ...
   extern int sip_add_contact (sip_msg_t, char *, char *, boolean_t, char *);
   ...
   extern int sip_add_accept (sip_msg_t, char *, char *, char *, char *);
   ...
   extern int sip_add_reply_to (sip_msg_t, char *, char *, char *, boolean_t);
   ...
   extern int sip_add_passertedid (sip_msg_t, char *, char *, boolean_t);
   extern int sip_add_ppreferredid (sip_msg_t, char *, char *, boolean_t);
   ...
   extern const sip_str_t *sip_get_passertedid_display_name (sip_header_value_t, int *);
   extern const sip_str_t *sip_get_passertedid_uri_str (sip_header_value_t, int *);
   extern const sip_str_t *sip_get_ppreferredid_display_name (sip_header_value_t, int *);
   extern const sip_str_t *sip_get_ppreferredid_uri_str (sip_header_value_t, int *);
   ...
   extern int sip_copy_header_by_name (sip_msg_t, sip_msg_t, char *, char *);
   ...
   extern sip_msg_t sip_create_response (const sip_msg_t, int, char *, char *, char *);
   extern int sip_create_OKack (const sip_msg_t, sip_msg_t, char *, char *, int, char *);
   extern char *sip_get_resp_desc (int);
   extern char *sip_get_branchid (const sip_msg_t, int *);

   extern const struct sip_header *sip_get_header (sip_msg_t, char *, sip_header_t, int *);
   extern const struct sip_value *sip_get_header_value (const struct sip_header *, int *);
   extern const struct sip_value *sip_get_next_value (sip_header_value_t, int *);
   extern const sip_str_t *sip_get_param_value (sip_header_value_t, char *, int *);
   extern const sip_param_t *sip_get_params (sip_header_value_t, int *);
   extern boolean_t sip_is_param_present (const sip_param_t *, char *, int);
   ...
   extern const sip_str_t *sip_get_contact_display_name (sip_header_value_t, int *);
   ...
   extern const sip_str_t *sip_get_via_sent_protocol_version (sip_header_value_t, int *);
   extern const sip_str_t *sip_get_via_sent_protocol_name (sip_header_value_t, int *);
   extern const sip_str_t *sip_get_via_sent_transport (sip_header_value_t, int *);
   ...
   extern sip_msg_t sip_create_dialog_req (sip_method_t, sip_dialog_t, char *, char *, int, char *, uint32_t, int);
   ...
   extern const struct sip_uri *sip_get_dialog_remote_target_uri (sip_dialog_t, int *);
   ...
   extern const sip_str_t *sip_get_uri_scheme (const struct sip_uri *, int *);
   extern const sip_str_t *sip_get_uri_user (const struct sip_uri *, int *);
   extern const sip_str_t *sip_get_uri_password (const struct sip_uri *, int *);
   extern const sip_str_t *sip_get_uri_host (const struct sip_uri *, int *);
   extern int sip_get_uri_port (const struct sip_uri *, int *error);
   extern const sip_param_t *sip_get_uri_params (const struct sip_uri *, int *);
   extern const sip_str_t *sip_get_uri_headers (const struct sip_uri *, int *);
   extern const sip_str_t *sip_get_uri_opaque (const struct sip_uri *, int *);
   extern const sip_str_t *sip_get_uri_query (const struct sip_uri *, int *);
   extern const sip_str_t *sip_get_uri_path (const struct sip_uri *, int *);
   extern const sip_str_t *sip_get_uri_regname (const struct sip_uri *, int *);
   extern boolean_t sip_is_uri_teluser (const struct sip_uri *);
   extern int sip_get_uri_errflags (const struct sip_uri *, int *);
...
/* Transaction functions */
   ...
   extern char *sip_get_trans_branchid (sip_transaction_t, int *);
   extern sip_method_t sip_get_trans_method (sip_transaction_t, int *);
   extern int sip_get_trans_state (sip_transaction_t, int *);
   extern const struct sip_message *sip_get_trans_resp_msg (sip_transaction_t, int *);
   extern const struct sip_message *sip_get_trans_orig_msg (sip_transaction_t, int *);
   extern void sip_hold_trans (sip_transaction_t);
   extern void sip_release_trans (sip_transaction_t);
   extern const struct sip_conn_object *sip_get_trans_conn_obj (sip_transaction_t, int *);
#ifdef	__cplusplus
}
#endif
